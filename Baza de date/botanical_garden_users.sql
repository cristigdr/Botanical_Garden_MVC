...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_nl3y1w69axl4ibui08visg2up` (`utilizator`),
  UNIQUE KEY `UKnl3y1w69axl4ibui08visg2up` (`utilizator`)
...
INSERT INTO `users` VALUES (8,'12345','admin','cristi'),(9,'12345','angajat','anca'),(14,'132','angajat','John');
